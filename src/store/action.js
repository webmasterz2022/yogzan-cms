...
export function getAllHirings() {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'get',
        url: `https://yogzan-server.herokuapp.com/hiring?limit=1000`,
...
export function getAllBookings() {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'get',
        url: `https://yogzan-server.herokuapp.com/book?limit=1000`,
...
export function getAllFixBookings() {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'get',
        url: `https://yogzan-server.herokuapp.com/fixbook?limit=1000`,
        // url: `http://localhost:5000/book/`,
      })
