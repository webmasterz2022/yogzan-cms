  ...
  return async dispatch => {
    try {
      ...
      const { data } = await axios({
        method: 'post',
        url: 'https://yogzan-server-stage.herokuapp.com/users/login',
        data: form
      })
...
export function register(form) {
  return async dispatch => {
    try {
      ...
      const { data } = await axios({
        method: 'post',
        url: 'https://yogzan-server-stage.herokuapp.com/users/register',
        data: form
      })
...
export function addPortfolio(portfolio, cb) {
  return async dispatch => {
    try {
      ...
      const { data } = await axios({
        method: 'post',
        url: `https://yogzan-server-stage.herokuapp.com/gallery/upload`,
...
export function updatePortfolio(portfolio, id) {
  return async dispatch => {
    try {
      ...
      const { data } = await axios({
        method: 'put',
        url: `https://yogzan-server-stage.herokuapp.com/gallery/${id}`,
...
export function getAllHirings() {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'get',
        url: `https://yogzan-server-stage.herokuapp.com/hiring?limit=10000`,
...
export function getAllBookings() {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'get',
        url: `https://yogzan-server-stage.herokuapp.com/book?limit=10000`,
...
export function getAllFixBookings() {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'get',
        url: `https://yogzan-server-stage.herokuapp.com/fixbook?limit=10000`,
        // url: `http://localhost:5000/book/`,
      })
...
export function updateFixBooking(dataForm, cb) {
  return async dispatch => {
    ...
    try {
      ...
      const { data } = await axios({
        method: 'put',
        url: `https://yogzan-server-stage.herokuapp.com/fixbook/${_id}`,
...
export function uploadHomepageGallery(file, imageName, index) {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'post',
        url: `https://yogzan-server-stage.herokuapp.com/gallery/upload-homepage`,
...
export function getAllCategories() {
  return async dispatch => {
    try {
      ...
      const { data } = await axios({
        method: 'get',
        url: `https://yogzan-server-stage.herokuapp.com/category`,
...
export function deleteCategory(id) {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'delete',
        url: `https://yogzan-server-stage.herokuapp.com/category/${id}`,
...
export function getAllTestimonies() {
  return async dispatch => {
    try {
      ...
      const { data } = await axios({
        method: 'get',
        url: `https://yogzan-server-stage.herokuapp.com/testimony`,
...
export function updateTestimony(id, testimony, cb) {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'put',
        url: `https://yogzan-server-stage.herokuapp.com/testimony/${id}`,
