  ...
  return async dispatch => {
    try {
      ...
      const { data } = await axios({
        method: 'post',
        url: 'https://yogzan-server.herokuapp.com/users/login',
        data: form
      })
...
export function addPortfolio(portfolio, cb) {
  return async dispatch => {
    try {
      ...
      const { data } = await axios({
        method: 'post',
        url: `https://yogzan-server.herokuapp.com/gallery/upload`,
...
export function updatePortfolio(portfolio, id) {
  return async dispatch => {
    try {
      ...
      const { data } = await axios({
        method: 'put',
        url: `https://yogzan-server.herokuapp.com/gallery/${id}`,
...
export function getAllHirings() {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'get',
        url: `https://yogzan-server.herokuapp.com/hiring?limit=10000`,
...
export function getAllBookings() {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'get',
        url: `https://yogzan-server.herokuapp.com/book?limit=10000`,
...
export function getAllFixBookings() {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'get',
        url: `https://yogzan-server.herokuapp.com/fixbook?limit=10000`,
        // url: `http://localhost:5000/book/`,
      })
...
export function updateFixBooking(dataForm, cb) {
  return async dispatch => {
    ...
    try {
      ...
      const { data } = await axios({
        method: 'put',
        url: `https://yogzan-server.herokuapp.com/fixbook/${_id}`,
...
export function uploadHomepageGallery(file, imageName, index) {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'post',
        url: `https://yogzan-server.herokuapp.com/gallery/upload-homepage`,
...
export function updateCategory(id, category, cb) {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'put',
        url: `https://yogzan-server.herokuapp.com/category/update/${id}`,
...
export function deleteCategory(id) {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'delete',
        url: `https://yogzan-server.herokuapp.com/category/${id}`,
...
export function updateTestimony(id, testimony, cb) {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'put',
        url: `https://yogzan-server.herokuapp.com/testimony/${id}`,
...
export function pathChecker(path, id) {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios({
        method: 'post',
        url: `https://yogzan-server.herokuapp.com/fixbook/check-path`,
        // url: `http://localhost:5000/testimony/${id}`,
        data: {
          path
        }
